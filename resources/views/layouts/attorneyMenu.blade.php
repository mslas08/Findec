    ...
    <div class="container-fluid">
      ...
      <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top ">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="{{URL::route('dataInput')}}">Data Input</a>
            </li>
            <div class="subnav">
            ...
            <div class="subnav">
                <button class="subnavbtn">Lookup<i class="fa fa-caret-down"></i></button>
                <div class="subnav-content">
                  <a href="#confirmation">New Client Addition</a>
                </div>
            </div> 
            <div class="subnav">
                <button class="subnavbtn">Admin<i class="fa fa-caret-down"></i></button>
                <div class="subnav-content">
                  <a href="#confirmation">Additional Access</a>
                  <a href="#confirmation">Firm Profile Input</a>
                </div>
            </div>  
